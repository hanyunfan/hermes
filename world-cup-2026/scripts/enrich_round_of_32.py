...
ANALYSIS: dict[str, dict] = {
    ...
    "760486": {
        ...
        "key_players_zh": [
            ...
            "罗恩文·威廉姆斯 #11（南非前锋，Mamelodi Sundowns）",
        ],
        "key_players_en": [
            "Alphonso Davies #19 (Canada captain, Bayern Munich LB)",
            "Jonathan David #9 (Canada striker, Lille, 2× Ligue 1 top scorer)",
            "Rowen Williams #11 (South Africa striker, Mamelodi Sundowns)",
        ],
        "news_focus_zh": "南非是本届非洲 5 队中唯一晋级 16 强的——整个非洲赛区的希望都压在这支球队上",
        "news_focus_en": "South Africa is the only one of Africa's 5 representatives in the R32 — the continent's hopes ride on this team",
        "record_potential_zh": [
    ...
    "760487": {
        ...
        "key_players_zh": [
            "维尼修斯·儒尼奥尔 #7（巴西边锋，皇家马德里，2024 金球奖）",
            "罗德里戈 #10（巴西边锋，皇家马德里）",
            "久保健英 #11（日本中场，皇家社会）",
            "三笘薰 #14（日本边锋，布莱顿）"
        ],
        "key_players_en": [
            "Vinícius Júnior #7 (Brazil winger, Real Madrid, 2024 Ballon d'Or)",
            "Rodrygo #10 (Brazil winger, Real Madrid)",
            "Takefusa Kubo #11 (Japan midfielder, Real Sociedad)",
            "Kaoru Mitoma #14 (Japan winger, Brighton)",
        ],
    ...
    "760488": {
        ...
        "watch_for_zh": [
            ...
            "摩洛哥 2022 卡塔尔世界杯打入 4 强，本届目标是追平——阿什拉夫 + 哈基米的巴黎圣日耳曼后防是核心",
        ...
        "watch_for_en": [
            ...
            "Morocco made the 2022 SF — Achraf + Hakimi (PSG) form the most decorated African back line in WC history.",
        ...
        "key_players_en": [
            ...
            "Noussair Mazraoui #3 (Morocco CB, PSG / Al Duhail)",
        ],
    ...
    "760490": {
        ...
        "watch_for_zh": [
            ...
            "科特迪瓦非洲杯冠军身份 + 挪威北欧硬朗风格，是本届最直白的\"身体足球\"对决"
        ],
        "watch_for_en": [
        ...
        "key_players_zh": [
            ...
            "弗朗切斯科·阿切尔比 #14（科特迪瓦中卫，本届非洲最佳球员）"
        ],
        "key_players_en": [
            "Erling Haaland #9 (Norway striker, Manchester City)",
            "Martin Ødegaard #10 (Norway midfielder, Arsenal captain)",
            "Seko Fofana #6 (Ivory Coast midfielder, Rennes / AC Milan)",
            "Franck Kessié #14 (Ivory Coast CB, AFCON 2023 Best Player)",
        ],
    ...
    "760493": {
        ...
        "watch_for_zh": [
            ...
            "德布劳内（曼城 34 岁）、卢卡库（那不勒斯 32 岁）——黄金一代的最后一次世界杯",
        ...
        "watch_for_en": [
            ...
            "De Bruyne (Man City, 34) and Lukaku (Napoli, 32) — the golden generation's last WC together.",
            "Senegal made the 2002 QF and 2022 R16 — one of Africa's most consistent big-tournament sides.",
        ],
        "key_players_zh": [
            "凯文·德布劳内 #7（比利时中场，曼城）",
            "罗梅卢·卢卡库 #9（比利时前锋，那不勒斯）",
            "萨迪奥·马内 #10（塞内加尔前锋，利雅得新月）",
            "帕佩·萨尔 #19（塞内加尔中场，热刺）"
        ],
        "key_players_en": [
            "Kevin De Bruyne #7 (Belgium midfielder, Manchester City)",
            "Romelu Lukaku #9 (Belgium striker, Napoli)",
            "Sadio Mané #10 (Senegal striker, Al-Ahli / former Bayern / Liverpool)",
    ...
    "760497": {
        ...
        "watch_for_en": [
            ...
            "David Alaba (Real Madrid, 32) is on a farewell tour — Austria's greatest-ever player, last WC.",
        ],
        "key_players_zh": [
    ...
    "760496": {
        ...
        "watch_for_zh": [
            ...
            "克罗地亚（L 组第二 6 分）2-4 英格兰、2-1 加纳、0-0 巴拿马——莫德里奇 39 岁仍是中场节拍器",
            "BMO Field（多伦多）是本届世界杯唯一加拿大主办城市——草地条件偏冷凉，6 月初体感 18-22°C",
            "C 罗（41 岁，利雅得胜利）vs 莫德里奇（39 岁，皇马）——两位金球奖得主的告别赛",
        ...
        "watch_for_en": [
            ...
            "Croatia (L2, 6 pts) went 2-4 ENG / 2-1 GHA / 0-0 PAN — Modrić (39) is still the metronome.",
            "BMO Field (Toronto) is the only Canadian host venue for the WC — cooler grass conditions than US/MX.",
            "Ronaldo (41, Al-Nassr) vs Modrić (39, Real Madrid) — two Ballon d'Or winners, both at their last WC.",
    ...
    "760499": {
        ...
        "key_players_zh": [
            "穆罕默德·萨拉赫 #10（埃及队长，利物浦前锋）",
            "马赫穆德·特雷泽盖 #7（埃及边锋，雷恩）",
            "马修·莱基 #11（澳大利亚边锋，墨尔本城）",
            "阿蒂姆·布塔 #9（澳大利亚前锋）"
        ],
        "key_players_en": [
            "Mohamed Salah #10 (Egypt captain, Liverpool striker)",
